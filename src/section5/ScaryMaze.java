...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		// new Robot().mouseMove(423, 316);
		new Robot().mouseMove(423, 350);
	...
	private void scare() {
		...
		//AudioClip sound = JApplet.newAudioClip(getClass().getResource("glass.wav"));
		...
		showScaryImage("jumpscare.png");
		
	
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("zombies.wav"));
